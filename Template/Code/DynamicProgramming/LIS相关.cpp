...
for (int i = 1; i < n; i ++ )
    ...
    {
        int pos = lower_bound(q.begin(), q.end(), a[i], greater<int>()) - q.begin();
        q[pos] = a[i];
        f[i] = pos + 1;
    }
...
for (int i = 1; i < n; i ++ )
    ...
    {
        int pos = upper_bound(q.begin(), q.end(), a[i], greater<int>()) - q.begin();
        q[pos] = a[i];
        f[i] = pos + 1;
    }
